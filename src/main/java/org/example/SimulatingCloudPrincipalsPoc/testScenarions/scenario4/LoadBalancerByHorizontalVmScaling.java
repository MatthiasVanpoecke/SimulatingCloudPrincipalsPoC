...
public class LoadBalancerByHorizontalVmScaling {
    ...
    public static void main(String[] args) {
        ...
        config.setSchedulingInterval(5);
        config.setCloudletsCreationInterval(10);
        config.setHosts(50);
        config.setHostPes(32);
        config.setInitialVms(1);
        config.setInitialCloudlets(6);
        config.setMaxVms(5);
        config.setVmDestructionDelay(10.0);
        config.setVmOverloadCpuPercentage(0.7);
        config.setCloudletLengths(new long[]{1000, 2000, 3000});

        var simulation = new LoadBalancerByHorizontalVmScaling(config);
        simulation.simulate();

    }

    public LoadBalancerByHorizontalVmScaling(SimulationConfig config) {
        this.config = config;
